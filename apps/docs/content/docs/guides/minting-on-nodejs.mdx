...
In this guide, we are building a minting transaction, but it could be any transactions. <Link href="/apis/txbuilder">Learn more about Transaction</Link>.
...
Then, lets create a new Transaction, loop through each recipient, and mint an assets with **mintAsset** (<Link href="/apis/txbuilder/minting">Learn more about minting transactions</Link>):
