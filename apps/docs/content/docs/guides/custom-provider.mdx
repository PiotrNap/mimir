...
To see the latest up-to-date list of interfaces used by Mesh, visit the GitHub repo (<Link href="https://github.com/MeshJS/mesh/blob/main/packages/mesh-common/src/interfaces/fetcher.ts">Fetcher</Link> & <Link href="https://github.com/MeshJS/mesh/blob/main/packages/mesh-common/src/interfaces/submitter.ts">Submitter</Link>).
...
For example, as of writing, IFetcher has 12 functions.
...
If you want to begin utilizing your own provider, looking at one of the existing providers is the ideal way to get started. Visit the <Link href="https://github.com/MeshJS/mesh/tree/main/packages/mesh-provider/src">GitHub repo</Link>, to see a list of providers.
